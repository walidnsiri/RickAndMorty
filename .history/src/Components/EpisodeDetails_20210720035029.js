...
const EpisodeDetails = ({...props }) => {
   ...
   /* const [episode, setEpisode] = useState({});
    ...
    for (const character in characters) { 
       const virgule = ',';
       const characterId = characters[character].split('/').pop();
       const concatstring = ""
       const idvirgule =concatstring.concat(characterId,virgule);
       character_ids = character_ids + idvirgule;
    }
   ...
   /* const charactersIds = ''; 
    ...
    useEffect(() => {
        props.fetchbyId(id);
        props.fetchbyIds(character_ids);
